        ...
        <header id="masthead-black-bar" className={`clearfix masthead-black-bar ${isNavbarExpanded ? 'active' : ''}`}>
                        ...
                        <div className="columns medium-7">
                            ...
                            <div className="row large-up-3 medium-up-3 small-up-2 no-underline medium-11">
                                <div className="column padding-bottom-medium">
                                    <a href="https://www.embl.de/research/index.php" className="">
                                        <h5 className="inline underline">Research:</h5> perform basic research in molecular biology
                                    </a>
                                </div>
                                <div className="column padding-bottom-medium">
                                    <a href="https://www.embl.de/services/index.html" className="">
                                        <h5 className="inline underline">Services:</h5> offer vital services to scientists in the member states
                                    </a>
                                </div>
                                <div className="column padding-bottom-medium">
                                    <a href="https://www.embl.de/training/index.php" className="">
                                        <h5 className="inline underline">Training</h5> scientists, students and visitors at all levels
                                    </a>
                                </div>
                                <div className="column padding-bottom-medium">
                                    <a href="https://www.embl.de/research/tech_transfer/index.html" className="">
                                        <h5 className="inline underline">Transfer</h5> and development of technology
                                    </a>
                                </div>
                                <div className="column padding-bottom-medium">
                                    <h5 className="inline underline">Develop</h5> new instruments and methods
                                </div>
                                <div className="column padding-bottom-medium">
                                    <h5 className="inline underline">Integrating</h5> life science research in Europe
                                </div>
                            </div>
                            <div className="margin-top-xlarge no-underline">
                                <h3>
                                    <a href="//embl.org" className="readmore">More about EMBL</a>
                                </h3>
                            </div>
                        </div>
                        <div className="columns medium-5">
                            ...
                            <div className="row medium-up-2 small-up-2">
                                ...
                                <div className="column">
                                    ...
                                    <p className="margin-bottom-none">EMBL-EBI: European Bioinformatics Institute</p>
                                </div>
                                <div className="column">
                                    <h5 className="inline">
            ...
            <div>
                <nav id="search-bar" className="search-bar global-masthead-interactive-banner">
                    ...
                    <div className="row">
                        <form id="global-search" name="global-search" action="/ebisearch/search.ebi" method="GET" className="">
                            <fieldset>
            ...
            <div>
                <nav className="row">
                    <ul id="global-nav" className="menu global-nav text-right">
                        <li className="home-mobile"><a href="https://www.ebi.ac.uk"></a></li>
                        <li className="where embl hide"><a href="http://www.embl.org">EMBL</a></li>
                        <li className="where barcelona hide"><a href="#">Barcelona</a></li>
                        <li className="where hamburg hide"><a href="#">Hamburg</a></li>
                        ...
                        <li className="what services"><a href="https://www.ebi.ac.uk/services">Services</a></li>
                        <li className="where ebi"><a href="https://www.ebi.ac.uk">EMBL-EBI</a></li>
                    </ul>
                </nav>
            </div>
        </header>
